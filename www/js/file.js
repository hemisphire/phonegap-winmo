/**
 * This class provides read and write access to the mobile device file system.
 * Based loosely on http://www.w3.org/TR/FileAPI/
 */
function FileMgr() 
{
...
FileWriter.prototype.writeAsText = function(file,text,bAppend)
{
  ...
  var params = [file];
  params.push(text);
  PhoneGap.exec("writeFile", [params]);
}
